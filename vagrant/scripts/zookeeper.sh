...
sed -i -e 's/-Xmx512M/-Xmx256M/' /opt/kafka_2.10-0.8.1.1/bin/zookeeper-server-start.sh
sed -i -e 's/-Xms512M/-Xms256M/' /opt/kafka_2.10-0.8.1.1/bin/zookeeper-server-start.sh
